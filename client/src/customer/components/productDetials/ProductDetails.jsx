            ...
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="overflow-hidden rounded-lg max-w-[30rem] mas-h-[35rem]">
                            <img
                        ...
                        <div className="flex flex-wrap space-x-5 justify-center">
                            {product.images.map((item)=>(
                                <div className="aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] h-[5rem] mt-4">
                                    <img
                                        src={item.src}
                                        alt={item.alt}
                                        className="h-full w-full object-cover object-center"
                    ...
                    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
                        ...
                        <div className="mt-4 lg:row-span-3 lg:mt-0">
                            ...
                            <div className="flex item-center space-x-2 mt-6 text-lg lg:text-xl text-gray-900">
                            ...
                            <div className="mt-6">
                                <div className='flex items-center space-x-3'>
                                    ...
                                    <p className="ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500">123 Reviews</p>
                                </div>
                            </div>
                    ...
                    <Grid container spacing={7}>
                        ...
                        <Grid item xs={5}>
                            ...
                            <div className="flex items-center space-x-3">
                                ...
                                <p className="opacity-60">543 Ratings</p>
                            </div>
