...
import { filters, singleFilters } from './flter';
...
export default function Product() {
    ...
    const handelRadioFilterChage = (e, sectionId) =>{
        const searchParams = new URLSearchParams(location.search);
                                                    ...
                                                    <Disclosure.Panel className="pt-6">
                                                        <div className="space-y-4">
                                                            {section.options.map((option, optionIdx) => (
                                                                <div key={option.value} className="flex items-center">
                                                                    <input
                                                                        onChange = {()=>handelFilter(option.value, section.id)}
                                                                        id={`filter-${section.id}-${optionIdx}`}
                                                                        name={`${section.id}[]`}
                                                                        defaultValue={option.value}
                                                                        type="checkbox"
                                                        ...
                                                        <div className="space-y-4">
                                                            <FormControl>
                                                                ...
                                                                {section.options.map((option, optionIdx) => (
                                                                    ...
                                                                    <FormControlLabel 
                                                                        key={optionIdx} 
                                                                        onChange={(e)=>handelRadioFilterChage(e, section.id)}
                                                                        value = {option.value} 
                                                                        control = {<Radio />} 
                                                                        label={option.label} 
                                                                    />
